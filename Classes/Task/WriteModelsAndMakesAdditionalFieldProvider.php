 ...
 */
class WriteModelsAndMakesAdditionalFieldProvider implements \TYPO3\CMS\Scheduler\AdditionalFieldProviderInterface
{
    /**
...
//            $parentObject->addMessage($GLOBALS['LANG']->sL('Sie haben keine Storage PID angegeben!'), \TYPO3\CMS\Core\Messaging\FlashMessage::ERROR);
            $result = true;
        }  else {
            $result = true;
        }
