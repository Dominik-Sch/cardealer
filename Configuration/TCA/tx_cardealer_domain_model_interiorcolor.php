...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:cardealer/Resources/Private/Language/locallang_db.xlf:tx_cardealer_domain_model_interiorcolor',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'iconfile' => 'EXT:cardealer/Resources/Public/Icons/tx_cardealer_domain_model_interiorcolor.gif'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'key_id' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:cardealer/Resources/Private/Language/locallang_db.xlf:tx_cardealer_domain_model_interiorcolor.key_id',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'title' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:cardealer/Resources/Private/Language/locallang_db.xlf:tx_cardealer_domain_model_interiorcolor.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
