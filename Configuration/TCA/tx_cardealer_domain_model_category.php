...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:cardealer/Resources/Private/Language/locallang_db.xlf:tx_cardealer_domain_model_category',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'iconfile' => 'EXT:cardealer/Resources/Public/Icons/tx_cardealer_domain_model_category.gif'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'key_id' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:cardealer/Resources/Private/Language/locallang_db.xlf:tx_cardealer_domain_model_category.key_id',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'title' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:cardealer/Resources/Private/Language/locallang_db.xlf:tx_cardealer_domain_model_category.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
